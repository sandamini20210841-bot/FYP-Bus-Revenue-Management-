        ...
        <div className="flex-1 flex flex-col gap-3 md:flex-row md:items-center">
          ...
          <div className="relative flex-1 min-w-[220px]">
            ...
            <input
              ...
              className="w-full rounded-xl border border-slate-200 pl-9 pr-3 py-2 text-sm text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
              value={searchQuery}
          ...
          <div className="relative min-w-[160px]">
            <button
              ...
              className="w-full inline-flex items-center justify-between gap-2 rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:outline-none transition-colors duration-150 ease-out focus:border-blue-500 focus:bg-blue-50/40"
            >
              <span>
